    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${sticky
          ? "dark:bg-darkColor dark:shadow-sticky-dark fixed z-[9999] bg-white !bg-opacity-50 shadow-sticky backdrop-blur-sm transition"
          ...
          <div className="relative -mx-4 flex items-center justify-center">
            ...
            <div className="flex w-full items-center justify-center px-4 ml-20">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-white px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-darkColor lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${navbarOpen
              ...
              <div className="ml-10 max-md:mr-16">
                <ThemeToggler />
              </div>
            </div>
          </div>
